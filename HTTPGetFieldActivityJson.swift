//
//  HTTPGetFieldActivityJson.swift
//  ShahrMa
//
...
class HTTPGetFieldActivity {
    
    
    let urlArea : String = "http://test.shahrma.com/api/ApiGiveFieldActivity"
    var errorcode : Int = 0
    var id : [Int] = []
    var name : [String] = []
    ...
    func parseJson(anyObj: AnyObject) {
        ...
        for jsonObject in anyObj as! Array<AnyObject>{
            ...
            let activity = (jsonObject as! NSDictionary)["Activity"] as! String
            id.append(ids)
